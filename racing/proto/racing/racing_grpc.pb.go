...
type RacingClient interface {
	...
	GetSingleRace(ctx context.Context, in *GetSingleRaceRequest, opts ...grpc.CallOption) (*Race, error)
}
...
func (c *racingClient) GetSingleRace(ctx context.Context, in *GetSingleRaceRequest, opts ...grpc.CallOption) (*Race, error) {
	out := new(Race)
	err := c.cc.Invoke(ctx, "/racing.Racing/GetSingleRace", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RacingServer interface {
	...
	GetSingleRace(context.Context, *GetSingleRaceRequest) (*Race, error)
}
...
func (UnimplementedRacingServer) GetSingleRace(context.Context, *GetSingleRaceRequest) (*Race, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSingleRace not implemented")
}
...
func _Racing_GetSingleRace_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSingleRaceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RacingServer).GetSingleRace(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/racing.Racing/GetSingleRace",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RacingServer).GetSingleRace(ctx, req.(*GetSingleRaceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Racing_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetSingleRace",
			Handler:    _Racing_GetSingleRace_Handler,
		},
	},
