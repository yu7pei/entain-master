...
type RacingClient interface {
	...
	GetRace(ctx context.Context, in *GetSingleRaceRequest, opts ...grpc.CallOption) (*Race, error)
}
...
func (c *racingClient) GetRace(ctx context.Context, in *GetSingleRaceRequest, opts ...grpc.CallOption) (*Race, error) {
	out := new(Race)
...
type RacingServer interface {
	...
	// Return a single race by id
	GetRace(context.Context, *GetSingleRaceRequest) (*Race, error)
...
func (UnimplementedRacingServer) GetRace(context.Context, *GetSingleRaceRequest) (*Race, error) {
...
func _Racing_GetRace_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RacingServer).GetRace(ctx, req.(*GetSingleRaceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
