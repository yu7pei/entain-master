...
type SportsClient interface {
	...
	UpdateWinner(ctx context.Context, in *UpdateWinnerRequest, opts ...grpc.CallOption) (*UpdateWinnerResponse, error)
...
func (c *sportsClient) UpdateWinner(ctx context.Context, in *UpdateWinnerRequest, opts ...grpc.CallOption) (*UpdateWinnerResponse, error) {
	out := new(UpdateWinnerResponse)
...
type SportsServer interface {
	...
	// UpdateWinner return whether success update a winner to an event
	UpdateWinner(context.Context, *UpdateWinnerRequest) (*UpdateWinnerResponse, error)
...
func (UnimplementedSportsServer) UpdateWinner(context.Context, *UpdateWinnerRequest) (*UpdateWinnerResponse, error) {
...
func _Sports_UpdateWinner_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SportsServer).UpdateWinner(ctx, req.(*UpdateWinnerRequest))
	}
	return interceptor(ctx, in, info, handler)
}
